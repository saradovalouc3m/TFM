# Define the theorical bandwidth as in Scott (1987)
...
# Reading the results of M Montecarlo simulation for big different sample sizes
library(R.matlab)
...
# Kolmogorov-Smirnov test for each sample size
M <- length(data)
total_data <- list()
mean_hucv <- numeric(M)
